...
\item
  ...
  meet-semilattice structure arises:
  e.g., it holds that $r \land s \leq r$, since
  the knowledge available at $r \land s$ is a subset of the knowledge at $r$.
\item
...
\item
  ...
  the type $t : @u$ expresses that the computation $t$ exists at $u$.
\item
...
\item
  ...
  \emph{narrowing transformation} $\textsf{narrow}_{u,v} : @u \Rightarrow @v$. The intuition is
  that if $u$ is a sublocation of $v$, then information available at the former
  is also available at the latter.
\item

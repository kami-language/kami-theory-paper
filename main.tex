...
\end{definition}
\begin{theorem}
  Let {\upshape$\mathcal{C}$} be a cartesian closed category. There is a covariant model
  of {\upshape MTT${}_{\mathcal{M}^\rho_{\textrm{Chor}}}$} that has
  {\upshape$\textbf{SyncIntProc}_{\mathcal{C}}$} as its compilation target category.
\end{theorem}
...
\begin{corollary}
  ...
  {\upshape$\textbf{SyncIntProc}_{\mathcal{C}}$}.
\end{corollary}

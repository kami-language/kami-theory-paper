...
\begin{corollary}
  ...
  {\upshape$\textsf{quote}_v$} and {\upshape$\textsf{eval}_u$}. Moreover, a
...
$\mathcal{M}^{\rho}_{\textrm{Chor}}$ is not suitable to be used as
a~choreographic programming language. The problem is that MTT has no notion of

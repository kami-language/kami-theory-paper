...
distributed system, but standard MTT instantiated with $\MrhoChor$ is not
...
communications that have not been performed yet.
...
\begin{definition}
  ...
  \item
    ...
    \ref{fig:mtt-leteval}).
  \item
    Restricting the reduction relation in a similar way to how the STLC
    reduction relation is restricted in Chor$\lambda$.
  \end{enumerate}
\end{definition}

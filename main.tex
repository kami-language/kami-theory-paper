...
unevaluated code for metaprogramming\cite{bak2020self} and staged
...
programming language introduced by Cruz-Filipe et~al., and extends STLC with
...
PhD thesis, is a framework for constructing modal type theories, with
...
under a modality'' as \emph{crisp induction principles}\cite{gratzer2023syntax}.

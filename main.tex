...
\begin{figure}[h]
  ...
  \begin{mathpar}
    ...
    {
      \Gamma \vdash_o \primitive{letmod } x \bm{\leftarrow} s \primitive{ in }
        t : B
    }
    \\
...
\begin{figure}
  ...
  \begin{mathpar}
    \inferrule*[Lab=Let-Eval]
    {
      \mu : \circle \to m
      \\
      \Gamma .\{\mu\} \vdash_{\circle} s : \langle A | \square \fatsemi @u \rangle
      \\
...
carried out together with Olivia R\"ohrig. The first author is tremendously
grateful for countless hours of debating syntax and semantics.

\medskip

This project is
  funded through NGI Zero Core\footnote{\url{https://nlnet.nl/core}}, a fund
  established by NLnet with financial support
